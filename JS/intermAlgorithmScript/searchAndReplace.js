...
function myReplace( str, before, after ) {
  ...
  function changeCase( beforeLetter = before[0], afterLetter = after[0] ) {
    return beforeLetter === beforeLetter.toUpperCase() ? afterLetter.toUpperCase() : afterLetter;
  };
...
const tests = [
  ['A quick brown fox Jumped over the lazy dog', 'Jumped', 'leaped', 'A quick brown fox Leaped over the lazy dog'],
